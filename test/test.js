var request = require('supertest')
  ...
  it("creates a new user via /user", function(done){
    var user = { name: "vishv2", age: "22", dob:"12/10/1990", email_id:"vishv6brahmbhatt@yahoo.com"};
  ...
  it("creates a new measurement via /user/measurements", function(done){
    var measurement = { "m_unit": "cm", "mid_neck_girth" : "10", "bust_girth" :"10", "waist_girth" : "10", 
    ...
    "person.name": "San", "person.email_id":"san@hotmail.com", "person.dob": "12/10/1990"};
    request("http://localhost:8020")
